...
public:
    ...
    void update_skeleton_layout1(QVector2D layout2, int hvgxID);
    void update_skeleton_layout2(QVector2D layout2, int hvgxID);
    void update_skeleton_layout3(QVector2D layout2, int hvgxID);
