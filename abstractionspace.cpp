      ...
      m_glFunctionsSet(false)
{
    ...
    ast1.pos_alpha = QVector4D(0, 20, 0.0, 1.0);
        ...
        neu4.pos_alpha  = QVector4D(80, 96, 0, 1);      // position interpolation
        neu4.trans_alpha = QVector4D(80, 96, 1, 1);    // alpha
        neu4.color_alpha = QVector4D(80, 96, 1, 1);       // color intp (toon/phong)
        neu4.point_size = QVector4D(80, 96, 7, 20);        // point size
